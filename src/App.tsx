            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="hover:shadow-lg transition-all duration-200">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Today +{stats.todayNotes} • {stats.connections} connections
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-all duration-200">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Completed {stats.completedTasks} • {stats.productivityScore}% rate
                  </p>
                </CardContent>
              </Card>
            ...
            {appState.insights.length > 0 && (
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {appState.insights.map((insight, index) => (
                    ...
                    <Tabs defaultValue="notes" className="w-full">
                      ...
                      <TabsContent value="notes" className="mt-4">
                        <div className="space-y-3">
                          {appState.notes.slice(0, 5).map((note) => (
